...
if __name__ == "__main__":
    ...
    print("\n############### ENTRENAMIENTO DE LA RED NEURONAL - XOR #################\n")
    n_ocultas=1
    while n_ocultas<=1:
        n_ocultas = int(input("Ingrese la cantidad de neuronas en la capa oculta: "))
        if n_ocultas<=1:
            print("Numero de neuronas ingresado no valido, reingres su cantidad.\n")
